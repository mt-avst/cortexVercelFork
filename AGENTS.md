...
Running it LOCALLY needs a real Postgres. Of the 219 entries (re-measured
2026-09-01, post-!328), 17 are database-backed. By FILE PATH they split 199
`backend/`, 14 `shared/`, 6 `frontend/`; by `project` - a different thing, and
a real manifest field since !307 - it is 213 backend to 6 frontend, because
