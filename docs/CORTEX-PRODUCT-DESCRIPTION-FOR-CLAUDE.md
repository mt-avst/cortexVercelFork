...
Three defects were recorded here on 2026-08-18. **All three are resolved as of 7.43.7 (2026-08-19).** Full detail in `KNOWN_ISSUES.md`; the rework plan is at `~/.claude/plans/cortex-authoring-ux-rework.md`, now at **step C2** (A0, A1, B1, B2, B3 and C1 are merged).
